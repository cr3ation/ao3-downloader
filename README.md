...
4. Click **Search** — results stream in page by page (narrated in the activity log). Result rows show word count, kudos, hits, a rating badge and a Complete/WIP badge; click the **Words / Kudos / Hits** column headers to re-sort locally without touching AO3. Works you already have are marked **In library** in the Status column, so you can tell at a glance what is new.
